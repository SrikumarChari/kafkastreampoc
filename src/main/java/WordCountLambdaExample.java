/**
 * Created by susheel.zaveri on 4/25/16.
 */
...
public class WordCountLambdaExample {
     ...
     */
        ...
        public static void main(String[] args) throws Exception {
            ...
            KStream<String, String> textLines = builder.stream(stringDeserializer, stringDeserializer, "streams-file-input");
            ...
            System.out.println("Printing : " + stringSerializer);
            wordCounts.to("streams-wordcount-output", stringSerializer, longSerializer);
